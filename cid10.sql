...
--
-- Host: 127.0.0.1
-- Generation Time: 28-Mar-2019 às 01:32
...
-- Database: `cid10`
--
CREATE DATABASE IF NOT EXISTS `cid10` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `cid10`;
...
CREATE TABLE `cid10` (
  ...
  `descricaoCid` varchar(100) DEFAULT NULL
...
INSERT INTO `cid10` (`idCid`, `descricaoCid`) VALUES
